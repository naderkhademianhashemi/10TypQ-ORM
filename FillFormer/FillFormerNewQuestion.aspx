...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%">
        ...
        <tr>
            <td align="center" colspan="2">
                <asp:GridView ID="GridView_Form_Questions" runat="server" AutoGenerateColumns="False"
                    ...
                    BorderWidth="1px" CellPadding="3"                 Width="600px"                    Style="text-align: center"
                    AllowPaging="True" 
        ...
        <tr>
            <td style="width: 196px">
                <asp:Label ID="Label6" runat="server" Width="108px" Text="سوال اجباریست یا اختیاری" 
                    Font-Size="9pt" Font-Names="Tahoma"></asp:Label>
            </td>
            <td>
