<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="FillFormerEditOption.aspx.cs" Inherits="FillFormerEditOption" Title="پرسشنامه" %>
    ...
    <table width="100%">
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <asp:GridView ID="GridView_ListItem" runat="server" AutoGenerateColumns="False"
                                    ...
                                    BorderWidth="1px" CellPadding="3" Width="600px"
        ...
        <tr>
            <td colspan="3" align="center" valign="middle">
                ...
                <asp:Label ID="Label3" runat="server" Text="بازگشت به صفحه طراحی سوال "></asp:Label>
