...
namespace ORM
{
    public class Group_Permissions:BaseGrpPrm
    {
        ...
        public static Group_Permissions get_Permission(String formid, String User_Name)
        {
            ...
            String sql_queryIsAdmin = "SELECT *  FROM Group_Users where IsAdmin=1 and LTRIM(User_Name) =N'" 
                + User_Name + "'";

            DataTable dtIsAdmin = connector.Select(sql_queryIsAdmin);
            ...
            else// only readable and Writeable
            {
